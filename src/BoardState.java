...
public class BoardState implements Comparable<BoardState> {
	...
	public BoardState getKindaDeepClone() {
	...
	public BoardState getNewBranch() {
		BoardState clone = getKindaDeepClone();
	 ...
	 * 
	 * static BoardState generateRandomBoard(int size, int[][] grid) {
	 * BoardState newBoard = new BoardState(size, grid); return newBoard; }
	 * 
	 */
}
